...
//	2 images (comparing):
//
//		-1 --> en una imagen einstein esta blanco y en la otra esta negro
//		0 --> compare einstein wiht a competlely black image
//		1 --> same image (einstaint wit  the same level of noise that the other einstein)
